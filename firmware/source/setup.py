...
if __name__ == "__main__":
    ...
    extra_scripts = [
        "pre:scripts/ignore_appledouble.py",
    ...
    pio_config[f"env:{keyboard}"] = {
        ...
        "build_flags": "\n".join(build_flags),
        # Finder creates AppleDouble sidecar files (._*) on removable volumes.
        # They are metadata, not C sources, so keep PlatformIO from compiling them.
        "build_src_filter": "\n".join(["${env.build_src_filter}", "-<**/._*>"]),
